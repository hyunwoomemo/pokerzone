export const Icon = {
  ...
  checkbox: 
    'https://newgenerationdatadev.blob.core.windows.net/data/template/t08/common/icon-checkbox-gray.svg',
  checkon:
  '	https://newgenerationdatadev.blob.core.windows.net/data/template/t08/common/icon-check-on.svg'
}